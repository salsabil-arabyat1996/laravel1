                    ...
                    <div class="col-lg-8 mt-4">
                        <div class="nav-menu">
                            ...
                            <nav class="mainmenu">
                                ...
                                @if (session('user_id'))
                                    <button class="btn btn-outline-warning my-2 my-sm-0 mr-1"  href="{{route('logout')}}">Logout</button>
                                @else
                                    <button class="btn btn-outline-warning my-2 my-sm-0 mr-1"  href="{{route('register')}}">Signup</button>
                                    <button class="btn btn-outline-warning my-2 my-sm-0 mr-1"  href="{{route('register-lessor')}}">Signup as a lessor</button>
                                    <button class="btn btn-outline-warning my-2 my-sm-0 mr-1"  href="{{route('login')}}">Login</button>
                                @endif
                            </form>
                        </div>
                    </div>

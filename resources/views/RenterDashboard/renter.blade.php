                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><span><a href="{{ route('Renterdashboard.edit', $farm->id) }}" data-toggle="tooltip" data-placement="top"
                                                        ...
                                                        </a><a href="#" data-toggle="tooltip" data-placement="top" title="Delete" onclick="event.preventDefault(); document.getElementById('delete-form-{{$farm->id}}').submit();">
                                                            <i class="fa fa-close color-danger"></i>
                                                        </a>

                                                        <form id="delete-form-{{$farm->id}}" action="{{ route('Renter.destroy', $farm->id) }}" method="POST" style="display: none;">
                                                            @csrf
                                                            @method('DELETE')
                                                        </form>
                                                </td>
